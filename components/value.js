          ...
          <div className="container px-6 py-8 mx-auto">
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:border-b-0">
              <div className='px-10 border-[#c5eaea] border-b-4 lg:border-b-0 lg:border-r-4'>
                ...
                <h1 className="mt-8 text-xl text-my_main-25 font-bold text-center">相手の立場で考える</h1>
                <p className="my-10 leading-5 text-my_main-25">
              ...
              <div className='px-10 border-[#c5eaea] border-b-4 lg:border-b-0 lg:border-r-4'>
                ...
                <h1 className="mt-8 text-xl text-my_main-25 font-bold text-center">後悔せずやる</h1>
                <p className="my-10 leading-5 text-my_main-25">
              ...
              <div className='px-10'>
                ...
                <h1 className="mt-8 text-xl text-my_main-25 font-bold text-center">常に謙虚で</h1>
                <p className="my-10 leading-5 text-my_main-25">
